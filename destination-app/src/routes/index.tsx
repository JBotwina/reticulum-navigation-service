			...
			<section className="island-shell rise-in relative overflow-hidden rounded-[2rem] px-6 py-10 sm:px-10 sm:py-14">
				...
				<div className="flex flex-wrap gap-3">
					...
					<a
						...
						className="rounded-full border border-[rgba(47,106,74,0.3)] bg-[rgba(47,106,74,0.12)] px-5 py-2.5 text-sm font-semibold text-[var(--palm)] no-underline transition hover:-translate-y-0.5 hover:bg-[rgba(47,106,74,0.2)]"
					>
